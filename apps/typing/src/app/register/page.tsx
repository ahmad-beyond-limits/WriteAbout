  ...
  return (
    <div className="w-full max-w-sm mx-auto my-auto flex flex-col gap-6 select-none">
      <div className="text-center">
        <h1 className="text-2xl font-light tracking-tight text-[var(--text-primary)]">New Profile</h1>
        <p className="text-xs text-[var(--text-secondary)] mt-0.5">
          Establish an operator identity to save velocity logs.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 rounded-[28px] bg-[var(--surface-primary)] border border-[var(--surface-border)] shadow-[0_20px_40px_-12px_rgba(0,0,0,0.03)] backdrop-blur-md flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[11px] uppercase tracking-wider font-semibold text-[var(--text-secondary)]">Username</label>
          <input
            type="text"
            required
            value={username}
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[11px] uppercase tracking-wider font-semibold text-[var(--text-secondary)]">Display Name</label>
          <input
            type="text"
            value={displayName}
            onChange={(e) => setDisplayName(e.target.value)}
            className="w-full px-4 py-2.5 rounded-full bg-[var(--surface-secondary)] text-[var(--text-primary)] text-xs outline-none border border-[var(--surface-border)] focus:border-[var(--text-primary)]"
            placeholder="e.g. Alex Swift"
          />
        </div>

        <div className="flex flex-col gap-1.5">
          <label className="text-[11px] uppercase tracking-wider font-semibold text-[var(--text-secondary)]">Email (Optional)</label>
          <input
            type="email"
            value={email}
